    ...
    <div>
      ...
      <div className={s.block}>
        ...
        <p className={s.block_text}>
          На нашому маркетплейсі ви маєте можливість не лише купувати товари, але й створювати
          власні магазини та представляти свої товари на нашому сервісі.
        </p>
      ...
      {isModalOpen && (
        <Modal isOpen={isModalOpen}>
          <div className={s.modal}>
            ...
            <p className={s.modal_subtitle}>Заповніть всі поля нижче, щоб створити свій профіль</p>
            <NewStoreForm />
